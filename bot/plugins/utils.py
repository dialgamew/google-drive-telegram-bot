...
@Client.on_message(filters.private & filters.incoming & filters.command(['start']) & filters.chat(config.SUDO_USERS))
...
@Client.on_message(filters.private & filters.incoming & filters.command(['help']) & filters.chat(config.SUDO_USERS))
